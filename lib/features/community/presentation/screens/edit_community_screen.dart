                  ...
                  child: _newProfileImage != null
                      ...
                      : (_existingProfileUrl != null && _existingProfileUrl!.isNotEmpty)
                          ...
                          : Container(
                              ...
                              child: const Icon(Icons.group, color: primary, size: 30),
                            ),
                ),
              ),
            ),
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: _isPublic ? primary.withValues(alpha: 0.1) : Colors.grey.shade50,
                borderRadius: BorderRadius.circular(8),
                border: Border.all(
          ...
          GestureDetector(
            ...
            child: Container(
              padding: const EdgeInsets.all(12),
              decoration: BoxDecoration(
                color: !_isPublic ? Colors.orange.withValues(alpha: 0.1) : Colors.grey.shade50,
                borderRadius: BorderRadius.circular(8),
                border: Border.all(
