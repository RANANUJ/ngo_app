                  ...
                  Column(
                    ...
                    children: [
                      if (eventDate != null)
                        Row(
                          children: [
                            const Icon(Icons.calendar_today, size: 12, color: primary),
                      ...
                      if (location != null && location.isNotEmpty) ...[
                        ...
                        GestureDetector(
                          ...
                          child: Row(
                            children: [
                              const Icon(Icons.location_on, size: 12, color: Color(0xFF0099B8)),
                              const SizedBox(width: 4),
                              Expanded(
                                child: Text(
                                  location,
                              ...
                              if (latitude != null && longitude != null)
                                const Icon(Icons.open_in_new, size: 10, color: Color(0xFF0099B8)),
                            ],
                          ),
                        ),
                      ],
