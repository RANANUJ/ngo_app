...
import 'package:ngo_app/screens/volunteer/volunteer_emergency_screen.dart';
import 'package:ngo_app/features/resources/presentation/screens/volunteer_resources_screen.dart';
import 'package:ngo_app/screens/volunteer/volunteer_impacts_screen.dart';
...
class _VolunteerDonationScreenState extends State<VolunteerDonationScreen> {
  ...
  void _calculateChartData() {
    ...
    for (var donation in donations) {
      ...
      if (date.isAfter(startOfCurrentMonth) || date.isAtSameMomentAs(startOfCurrentMonth)) {
        ...
        currentDayData[dayOfMonth] = (currentDayData[dayOfMonth] ?? 0) + donation.amount;
      } else if (date.isAfter(startOfLastMonth) && date.isBefore(startOfCurrentMonth)) {
        final dayOfMonth = date.day - 1;
        lastDayData[dayOfMonth] = (lastDayData[dayOfMonth] ?? 0) + donation.amount;
      }
    }
  ...
  Widget build(BuildContext context) {
    ...
    final isLoading = _isLoadingLocal || donationController.isLoading;
  ...
  Widget _buildFeatureGrid() {
    final features = [
      _FeatureItem(
        title: 'Emergency',
        imagePath: 'assets/Pngtreeemergency light flashing red warning_18600445.png',
      ...
      _FeatureItem(
        title: 'Donation Req',
        imagePath: 'assets/Pngtreemoney donation vector icon in_5684260.png',
      ...
      _FeatureItem(
        ...
        imagePath: 'assets/Pngtreeshare resource_5610380.png',
