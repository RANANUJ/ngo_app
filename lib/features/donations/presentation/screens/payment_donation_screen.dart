...
import 'package:ngo_app/features/payments/data/services/razorpay_service.dart';
...
class _PaymentDonationScreenState extends State<PaymentDonationScreen> {
  ...
  Future<void> _loadUserData() async {
    ...
    if (user != null) {
      ...
      try {
        ...
        final profile = await profileController.loadUserProfile(user.uid, 'volunteer') ??
                        await profileController.loadUserProfile(user.uid, 'ngo');
  ...
  Future<void> _handlePaymentSuccess(PaymentSuccessResponse response) async {
    try {
      // Save donation to Firestore using RazorpayService
      // razorpay_service.dart automatically fetches ngoId if it is null
