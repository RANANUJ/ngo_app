...
class _BlockchainDonationScreenState extends State<BlockchainDonationScreen> {
  ...
  Widget _buildTransactionsList() {
    ...
    return StreamBuilder<List<Map<String, dynamic>>>(
      stream: donationController.streamBlockchainDonations(widget.ngoData.id),
  ...
  Widget _buildTransactionCard(Map<String, dynamic> data) {
    ...
    if (createdAtObj != null) {
      ...
      if (createdAtObj is Timestamp) {
        date = createdAtObj.toDate();
      } else if (createdAtObj is DateTime) {
        date = createdAtObj;
      }
      if (date != null) {
      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: blockchainColor.withValues(alpha: 0.1),
