...
import 'package:ngo_app/screens/ngo/ngo_verification_status_screen.dart';
import 'package:ngo_app/screens/ngo/ngo_home_screen.dart' as ngo_home;
        ...
        if (ngoData != null && ngoData.status == RegistrationStatus.approved) {
          if (mounted) {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (context) => ngo_home.NgoHomeScreen(ngoData: ngoData),
              ),
            );
          }
          return;
