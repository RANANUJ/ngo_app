...
class CacheService {
  ...
  Future<void> preloadAssetImages(BuildContext context) async {
    ...
    debugPrint('Preloaded ${_preloadedAssets.length} asset images');
  }
  ...
  Future<void> _setDiskCache(String url, Uint8List data) async {
    ...
    try {
      ...
      debugPrint('Error writing disk cache: $e');
    }
  }
...
class DataPreloader {
  ...
  Future<void> preloadAllData() async {
    ...
    try {
      ...
      _isPreloaded = true;
      debugPrint('DataPreloader: All data preloaded');
    } catch (e) {
  ...
  Future<void> _preloadCommunityPosts() async {
    try {
      ...
      debugPrint('Preloaded ${posts.length} community posts');
    } catch (e) {
      debugPrint('Error preloading community posts: $e');
    }
  }
  ...
  Future<void> _preloadFeedPosts() async {
    try {
      ...
      await CacheService().preloadNetworkImages(imageUrls);
      debugPrint('Preloaded ${posts.length} feed posts');
    } catch (e) {
      debugPrint('Error preloading feed posts: $e');
    }
  }
  ...
  Future<void> _preloadCampaigns() async {
    try {
      ...
      await CacheService().preloadNetworkImages(imageUrls);
      debugPrint('Preloaded ${campaigns.length} campaigns');
    } catch (e) {
      debugPrint('Error preloading campaigns: $e');
    }
  }
  ...
  Future<void> _preloadEvents() async {
    try {
      ...
      debugPrint('Preloaded ${events.length} events');
    } catch (e) {
      debugPrint('Error preloading events: $e');
    }
  }
